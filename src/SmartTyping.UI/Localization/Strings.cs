...
internal static class Strings
{
    public static readonly IReadOnlyDictionary<string, (string En, string Th)> Table =
        new Dictionary<string, (string En, string Th)>
        {
            ...
            ["Settings_UndoCorrection"] = ("Undo correction", "ยกเลิกการแก้ภาษา"),
            ...
            ["Tray_Undone"] = ("Correction undone", "ยกเลิกการแก้แล้ว"),
            ["Tray_UndoneBody"] = ("Restored ‘{0}’ · it won’t be corrected again", "คืนค่า ‘{0}’ · จะไม่แก้คำนี้อีก"),
